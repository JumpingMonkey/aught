...
class CareerPageResource extends Resource
{
     ...
     * @var string
     */
    public static $model = CareerPageModel::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Flexible::make('Вакансии', 'vacancies')
            ->addLayout('Вакансия', 'vacancy', [
                Text::make('Название вакансии', 'vacancy_title'),
                MediaLibrary::make('Фото', 'img'),
                Text::make('Местоположение вакансии', 'location_title'),
                Text::make('Вид занятости', 'type_cooperation'),
                Textarea::make('Описание вакансии', 'vacancy_description'),
            ])
        ];
    }
